    ...
    <div id="features" className={css(style, styles.container)}>
        ...
        <div className={css(styles.featuresContainer)}>
            <FeatureBox image={graphImg}>
                Our advanced statistics panel allows you to analyze usage of your links
                in a simple and intuitive way.
            </FeatureBox>
            <FeatureBox image={deliveryImg}>
                Management panel gives you quick overview of your links. It allows you
                to supervise them the way you like.
            </FeatureBox>
